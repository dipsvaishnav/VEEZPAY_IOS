...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        InitialRootViewConrroller()

    }

    func InitialRootViewConrroller() {
        
        if Retrive(UDKey.kUser_ID) as! String != "" {
            ...
            if Retrive(UDKey.kFirstTimeLaunch) as! String != "" {
                ...
                let destinationVC = AppStoryboard.Main.instance.instantiateViewController(withIdentifier: "OnBoardingVC") as! OnBoardingVC
                let navigation = UINavigationController(rootViewController: destinationVC)
                navigation.navigationBar.isHidden = true
                window?.rootViewController = navigation
                navigation.interactivePopGestureRecognizer?.isEnabled = false
